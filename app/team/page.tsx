...
export const metadata: Metadata = {
  title: 'Team — Meet the Architects at ECO.AI',
  description:
    'Meet the architects, designers, and project managers who make ECO.AI one of the most respected architecture studios in the world.',
};
...
const team = [
  {
    ...
    bio: 'James founded ECO.AI in 2010 after 12 years at leading international practices. His work spans residential, commercial, and civic typologies across four continents. He holds a Master of Architecture from the Architectural Association and is a Fellow of the AIA.',
  ...
  },
  {
    ...
    bio: 'Axon leads the conceptual direction of the studio, overseeing design quality across all projects. A graduate of ETH Zürich, he brings a rigorous European sensibility to ECO.AI\'s work, with a particular focus on materiality and tectonic expression.',
  ...
  },
  {
    ...
    bio: 'Mara leads ECO.AI\'s interior design practice, bringing a deep understanding of spatial psychology, material culture, and the craft of furnishing to every project. Her residential interiors have been published in Wallpaper*, Architectural Digest, and Frame Magazine.',
  ...
  },
  {
    ...
    bio: 'Diego joined ECO.AI in 2015 and has since led the delivery of over 40 projects across residential, hospitality, and mixed-use typologies. His technical expertise — particularly in structural timber and prefabricated systems — has been instrumental in ECO.AI\'s sustainability programme.',
    image: '/images/portrait_1.jpg',
  ...
  },
  {
    ...
    bio: 'Yuki brings precision and calm to the most complex delivery challenges. A graduate of Tokyo University of the Arts, she leads construction administration across ECO.AI\'s commercial portfolio and has overseen projects in Japan, Australia, and the United Kingdom.',
    image: '/images/portrait_2.jpg',
  ...
  },
  {
    ...
    bio: 'Rafa leads ECO.AI\'s digital practice, integrating computational design, parametric modelling, and immersive visualisation tools into the studio\'s workflow. His work ensures that every client experiences their project in full before a single foundation is poured.',
    image: '/images/portrait_3.jpg',
      ...
      <section className="bg-[#0B0B0C] pt-[120px] pb-20 px-6 md:px-20">
        <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
          ...
          <p className="text-white/50 text-base leading-relaxed max-w-md lg:pb-2">
            ECO.AI is built on talent. Our team of architects, designers, and project managers
      ...
      <section className="bg-accent py-24 px-6 md:px-20">
        <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          ...
          <Link
            ...
            aria-label="Contact ECO.AI about career opportunities"
          >
