...
const projects: Record<string, {
  ...
  'cliffside-residence': {
    ...
    galleryImages: [
      ...
      '/images/interior_living.jpg',
      '/images/abstract_detail.jpg',
    ],
  ...
  'meridian-tower': {
    ...
    heroImage: '/images/exterior_tower.jpg',
    galleryImages: [
      '/images/interior_gallery.jpg',
      '/images/exterior_tower.jpg',
    ],
  ...
  'pavilion-garden': {
    ...
    heroImage: '/images/interior_gallery.jpg',
    galleryImages: ['/images/exterior_villa.jpg'],
  ...
  'urban-commons': {
    ...
    heroImage: '/images/exterior_tower.jpg',
    galleryImages: ['/images/interior_gallery.jpg'],
  ...
  'the-foundry': {
    ...
    galleryImages: ['/images/interior_kitchen.jpg'],
  ...
  'cedarwood-retreat': {
    ...
    galleryImages: ['/images/interior_living.jpg'],
